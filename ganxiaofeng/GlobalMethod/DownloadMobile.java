...
public class DownloadMobile {
   ...
   {  
	...
	public void login(){
		...
		driver.findElement(By.xpath("//*[@id='login-area']/ul/li/a/span")).click(); //通过id定位到慕课官网上的 登录按钮
		waitForSecond();
	...
	public  void DownloadMobile() throws InterruptedException{
		...
		DownloadMobile downloadMobile = new DownloadMobile();
		downloadMobile.init();
		downloadMobile.login();	
